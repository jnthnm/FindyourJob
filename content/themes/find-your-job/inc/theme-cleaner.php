...
function wpo_dashboard_widget_function() {
  ...
  <div class="acceuil">
    <h2>Projet</h2>
    <p>Travail d'équipe Cyril, Jonathan M , Ludovic et Audrey </p>
...
function wpo_add_dashboard_widget() {
  wp_add_dashboard_widget('wpo_summary_dashboard_widget', 'Mon eval', 'wpo_dashboard_widget_function');
}
...
function wpo_remove_footer_admin() {
	return 'Réalisé par  Cyril, Jonathan M , Ludovic et Audrey  ';
}
