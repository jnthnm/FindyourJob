...
<div class="field-selector-pills">
    ...
    <div title="<?php echo RM_UI_Strings::get("FIELD_HELP_TEXT_YOUTUBE"); ?>" class="rm_button_like_links" onclick="add_new_widget_to_page('YouTubeV')"><a href="javascript:void(0)">YouTube Video</a></div> 
    <div title="<?php echo RM_UI_Strings::get("FIELD_HELP_TEXT_IFRAME"); ?>" class="rm_button_like_links" onclick="add_new_widget_to_page('Iframe')"><a href="javascript:void(0)">iFrame Embed</a></div> 
    <div title="<?php echo RM_UI_Strings::get("FIELD_HELP_TEXT_IMAGEV"); ?>" class="rm_button_like_links" onclick="add_new_widget_to_page('ImageV')"><a href="javascript:void(0)">Image</a></div>
    <div title="<?php echo RM_UI_Strings::get("FIELD_HELP_TEXT_PRICEV"); ?>" class="rm_button_like_links" onclick="add_new_widget_to_page('PriceV')"><a href="javascript:void(0)"> Price</a></div>
    <div title="If you have set form limits, you can display the limit status using this widget" class="rm_button_like_links rm-widget-lg" onclick="add_new_widget_to_page('SubCountV')"><a href="javascript:void(0)"> Submission Countdown</a></div>
    <div title="Display a location with marker using GoogleMaps" class="rm_button_like_links" onclick="add_new_widget_to_page('MapV')"><a href="javascript:void(0)">Map</a></div>  
    <div title="Display stats about the form using graphs and charts" class="rm_button_like_links" onclick="add_new_widget_to_page('Form_Chart')"><a href="javascript:void(0)">Form Data Chart</a></div> 
    <div title="Display various properties of the form" class="rm_button_like_links" onclick="add_new_widget_to_page('FormData')"> <a href="javascript:void(0)">Form Meta-Data</a></div>
    <div title="Display latest registrations/ submissions data in your form" class="rm_button_like_links" onclick="add_new_widget_to_page('Feed')"><a href="javascript:void(0)"><?php echo $data->form->form_type==0 ? 'Submission Feed' : 'Registration Feed'; ?></a></div>
    </div>
    </div>
